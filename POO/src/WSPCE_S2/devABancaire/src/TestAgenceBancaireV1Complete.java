...
public class TestAgenceBancaireV1Complete extends TestCase {
    ...
    // Ajoute entre 0 et MAX_CPTS_TESTS comptes de tabCptesTests dans l'AgenceBancaire ag
    ...
    // Retire entre 0 et MAX_CPTS_TESTS comptes de tabCptesTests dans l'AgenceBancaire ag
    ...
    public void testAddCompte_3 () {
		...
		// Test ajout dejo comptes sur AgenceBancaire après des ajouts et des retraits de comptes
    ...
    public void testAddCompte_5 () throws ABCompteInexistantException {
    	...
    	// Teste le nom et la localisation de l'agence sur des ajouyts de comptes
    ...
    public static void main(String argv[]) {
        ...
        suite.addTestSuite(TestAgenceBancaireV1Complete.class);
